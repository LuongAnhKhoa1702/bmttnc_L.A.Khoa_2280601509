...
def receive_data(ssl_socket):
    try:
        ...
        pass # Handle potential exceptions, e.g., connection reset by peer
    finally:
        ssl_socket.close()
        print("Kết nối đã đóng.")

# Note: The rest of the client connection and sending logic would go here.
# This snippet only covers the receive_data function as shown in the image.
# Tạo socket client
